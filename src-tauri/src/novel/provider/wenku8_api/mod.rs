...
use crate::novel::{
    domain::{
        ChapterContent, ChapterNode, ChapterSummary, DiscoveryList, HealthStatus, NovelDetail,
        NovelOverview, NovelSummary, PageInfo, RecommendBlock, Volume,
    },
    error::NovelError,
};
use client::Wenku8Client;

pub(super) const SOURCE_ID: &str = "wenku8_api";
...
impl NovelSource for Wenku8ApiSource {
    ...
    async fn chapter(
        ...
        self.chapter_with_title(novel_id, chapter_id, None).await
    }
