...
import { getLatest, getRank, getRanking, searchDiscovery } from "../services/novel";
...
export const mangaDiscoveryAdapter: DiscoveryAdapter<MangaSummary> = {
  ...
  async search(query: string, page: number, mode: BookSearchMode): Promise<DiscoveryList<MangaSummary>> {
    ...
    return { items, pagination: { page, previous: null, next: null, first: 1, last } };
  },
};
